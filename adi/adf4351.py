...
class adf4351(attribute, context_manager):
    """ADF4351 Microwave Wideband Synthesizer with Integrated VCO
    ...
    def __init__(self, uri=""):
        ...
        if not self._ctrl:
            raise Exception("ADF4351 device not found")
    ...
    def frequency_resolution_altvolt0(self):
        return self._get_iio_attr("altvoltage0", "frequency_resolution", True, self._ctrl)

    @frequency_resolution_altvolt0.setter
    def frequency_resolution_altvolt0(self, value):
        self._set_iio_attr("altvoltage0", "frequency_resolution", True, value, self._ctrl)
